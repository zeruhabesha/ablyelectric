...
export default function AboutPage() {
  ...
  const testimonials = [
    {
      text: "ABLY ELECTRIC has been our trusted partner for several years. Their expertise and commitment to quality have greatly improved our operations.",
      author: "Abebe Kebede",
      position: "General Manager",
      company: "Ethio National Industries",
      rating: 5,
      image: "/placeholder.svg?height=60&width=60",
    },
    {
      text: "The electrical solutions provided by ABLY have significantly enhanced our facility's efficiency. We appreciate their team's professionalism and support.",
      author: "Fatuma Ali",
      position: "Plant Supervisor",
      company: "Addis Manufacturing PLC",
      rating: 5,
      image: "/placeholder.svg?height=60&width=60",
    },
    {
      text: "We depend on ABLY's reliable products for our infrastructure projects. Their dedication to excellence ensures our projects are completed to the highest standards.",
